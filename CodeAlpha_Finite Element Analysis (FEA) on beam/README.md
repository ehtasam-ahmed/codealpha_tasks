...
3.  **Boundary Conditions:**
    * **Fixtures:** Fixed supports applied to both ends of the beam to simulate a simply supported condition.
    * **Loading:** Vertical force applied to the top flange to simulate operational stress.
4.  **Analysis Types:**
    * **Static Nodal Stress (von Mises):** To identify regions of maximum stress.
    * **Displacement Analysis:** To observe the deformation scale and total resultant displacement.
    * **Strain Analysis:** To evaluate the intensity of deformation.
    * **Factor of Safety (FOS):** Calculated to ensure the design meets safety standards (Minimum FOS achieved: 4.4).

## Results & Observations
The simulation confirmed that the I-beam remains within the elastic limit of the selected material. 
* **Maximum Stress:** Observed at the center of the span, well below the yield strength.
* **Structural Integrity:** The high Factor of Safety indicates that the component is over-engineered for the applied load, ensuring long-term reliability.
